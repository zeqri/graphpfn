...
#     --min-molecules 1000 --max-molecules 2000 --n-sampler-workers 11 --prefetch-factor 4 --n-steps 10000 --lr 0.0003



torchrun --nproc_per_node=4 paper/dev/limix_backbone_gnn_pooling_multi_dataset_multi_agg_pooler_multi_task_fit_test.py \
    --min-molecules 1000 --max-molecules 3000 --n-sampler-workers 11 --prefetch-factor 4 --n-steps 100 



    # srun --jobid=14162009  --overlap --pty bash   